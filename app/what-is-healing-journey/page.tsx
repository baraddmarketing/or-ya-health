    ...
    <main className="min-h-screen flex flex-col items-center w-full overflow-x-hidden rtl">
      ...
      <Section className="py-16 md:py-24 relative">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            ...
            {/* Stage 1: Body */}
            <Card className="bg-white/80 backdrop-blur-sm border-none shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 group">
              <CardHeader className="text-center pb-2">
                ...
                <CardTitle className="font-serif font-bold text-primary">שלב ראשון: הגוף</CardTitle>
              </CardHeader>
              <CardContent className="text-center">
                <h4 className="font-bold mb-2 text-foreground">מה קורה לי בגוף?</h4>
                <p className="text-foreground mb-4">
                  קבלת ידע מדוייק על מנגנון הכאב, הקשר לטראומה, חרדות ועייפות.
                </p>
                <p className="font-semibold text-primary border-t border-primary/10 pt-4">
            ...
            <Card className="bg-white/80 backdrop-blur-sm border-none shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 group">
              <CardHeader className="text-center pb-2">
                ...
                <CardTitle className="font-serif font-bold text-secondary-foreground">שלב שני: הנפש</CardTitle>
              </CardHeader>
              <CardContent className="text-center">
                <h4 className="font-bold mb-2 text-foreground">לשחרר ולאמן</h4>
                <p className="text-foreground mb-4">
                  בירור מנגנוני הגנה וספקות. שחרור ידע ישן ואימון המוח לקבלת החדש.
                </p>
                <p className="font-semibold text-secondary-foreground border-t border-secondary-foreground/10 pt-4">
            ...
            <Card className="bg-white/80 backdrop-blur-sm border-none shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 group">
              <CardHeader className="text-center pb-2">
                ...
                <CardTitle className="font-serif font-bold text-accent-foreground">שלב שלישי: הרוח</CardTitle>
              </CardHeader>
              <CardContent className="text-center">
                <h4 className="font-bold mb-2 text-foreground">לצלול לעומק</h4>
                <p className="text-foreground mb-4">
                  חקירת מחשבות ודפוסים עמוקים. הבנה כיצד הם מעצבים את חיינו וכיצד לשנותם.
                </p>
                <p className="font-semibold text-accent-foreground border-t border-accent-foreground/10 pt-4">
            ...
            <Card className="bg-white/80 backdrop-blur-sm border-none shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 group">
              <CardHeader className="text-center pb-2">
                ...
                <CardTitle className="font-serif font-bold text-primary">שלב רביעי: הנשמה</CardTitle>
              </CardHeader>
              <CardContent className="text-center">
                <h4 className="font-bold mb-2 text-foreground">מבט חומל וריבוני</h4>
                <p className="text-foreground mb-4">
      ...
      <Section className="py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto bg-white/90 backdrop-blur-sm rounded-3xl p-8 md:p-12 shadow-2xl border border-border text-center relative overflow-hidden">
            <div className="absolute top-0 left-0 w-full h-2 bg-gradient-to-r from-primary via-secondary to-primary" />
            
            <h3 className="font-serif font-bold text-foreground mb-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Button size="lg" className="bg-primary hover:bg-primary/90 text-white px-10 py-8 h-auto rounded-full shadow-lg hover:shadow-xl transition-all w-full sm:w-auto">
